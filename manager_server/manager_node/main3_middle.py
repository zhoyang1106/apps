...
def update_weights(app, process_time, worker_id):
    ...
    process_time = math.log(process_time, math.e) > 0 if math.log(process_time, math.e) + 0.5 else math.log(process_time, math.e) - 0.5
    ...
    for n, w in zip(task_counts, app['dynamic_weight'].values()):
        weights.append(1 / (1 + alpha * w + n * beta))
